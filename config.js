...
/**
 * @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
 * ENTER YOUR PERSONAL TWITCH CONFIGURATION SETTINGS HERE
 * @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
 */
config.twitch.channelName = 'channelName';
config.twitch.botAccount.username = 'username';
config.twitch.botAccount.password = 'password';


/**
 * @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
 *       ENTER YOUR CHAT OVERLAY BOT SETTINGS HERE
 * @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
 */
/**
